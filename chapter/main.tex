...
\newpage
\setcounter{page}{1}
\input{chapter/autres/sections/01_introduction.tex}
\input{chapter/autres/sections/02_deep_values_and_universalism.tex}
\input{chapter/autres/sections/03_foreign_aid.tex}
\input{chapter/autres/sections/04_international_taxation.tex}
\input{chapter/autres/sections/05_global_governance.tex}
\input{chapter/autres/sections/06_international_climate_policy.tex}
\input{chapter/autres/sections/07_willingness_to_contribute.tex}
\input{chapter/autres/sections/08_explaining_lack_of_prominence.tex}
\input{chapter/autres/sections/09_conclusion.tex}
